...
export const metadata: Metadata = {
  title: 'Signs Your Deck Needs Restaining on the Northern Beaches | Working Colours Painting Northern Beaches',
  description:
    "How to tell if your deck is due for restaining — the water test, visual warning signs, UV damage, and what happens if you leave it too long. Northern Beaches deck specialists.",
  alternates: {
    canonical: 'https://www.wcpainting.com.au/blog/signs-deck-needs-restaining-northern-beaches',
  },
  openGraph: {
    type: 'website',
    title: 'Signs Your Deck Needs Restaining on the Northern Beaches | Working Colours Painting Northern Beaches',
    description:
      "How to tell if your deck is due for restaining — the water test, visual warning signs, UV damage, and what happens if you leave it too long. Northern Beaches deck specialists.",
    url: 'https://www.wcpainting.com.au/blog/signs-deck-needs-restaining-northern-beaches',
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Signs Your Deck Needs Restaining on the Northern Beaches",
      "item": "https://www.wcpainting.com.au/blog/signs-deck-needs-restaining-northern-beaches"
    }
  ]
};
...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "Signs Your Deck Needs Restaining on the Northern Beaches",
  "description": "How to tell if your deck is due for restaining — the water test, visual warning signs, UV damage, and what happens if you leave it too long. Northern Beaches deck specialists.",
  "url": "https://www.wcpainting.com.au/blog/signs-deck-needs-restaining-northern-beaches",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.wcpainting.com.au/blog/signs-deck-needs-restaining-northern-beaches"
  },
  "author": {
    "@type": "Organization",

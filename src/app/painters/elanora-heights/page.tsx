...
export const metadata: Metadata = {
  title: 'Painter Elanora Heights | Working Colours Painting Services',
  description: "Painter Elanora Heights — interior, exterior and timber work for hilltop homes with bushland surroundings. 18 years Northern Beaches experience. Call 0434 030 222.",
  alternates: {
    canonical: 'https://www.wcpainting.com.au/painters/elanora-heights',
  },
  openGraph: {
    type: 'website',
    title: 'Painter Elanora Heights | Working Colours Painting Services',
    description: "Painter Elanora Heights — interior, exterior and timber work for hilltop homes with bushland surroundings. 18 years Northern Beaches experience. Call 0434 030 222.",
    url: 'https://www.wcpainting.com.au/painters/elanora-heights',
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Painter Elanora Heights",
      "item": "https://www.wcpainting.com.au/painters/elanora-heights"
    }
  ]
};
